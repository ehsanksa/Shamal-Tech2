...
import {
  downloadTrainingInterestSubmissions,
  type ExportFormat,
} from './exportSubmissions'

export const ExportFormDataListActions: React.FC = () => {
  ...
  const handleExport = async (format: ExportFormat) => {
    ...
    try {
      await downloadTrainingInterestSubmissions(format)
    } catch (e) {
  ...
  return (
    ...
    >
      <span style={{ fontSize: '0.875rem', color: 'var(--theme-elevation-500)' }}>
        Download all interest form submissions:
      </span>
      <button
        type="button"
...
export default ExportFormDataListActions
